permissionset 50000 GeneratedPermission //B2BSSD16MAR2023
{
    ...
    Permissions = tabledata "Archive Indent Header"=RIMD,
       ...
       // report "INWARD RECEIPT New"=X,
        ...
        tabledata "CWIP Details"=RIMD,
        tabledata "CWIP Header"=RIMD,
        tabledata "CWIP Ledger Entry"=RIMD,
        tabledata "CWIP Line"=RIMD,
        tabledata "PO Specifications"=RIMD,
        tabledata QuoteSpecifications=RIMD,
        table "CWIP Details"=X,
        table "CWIP Header"=X,
        table "CWIP Ledger Entry"=X,
        table "CWIP Line"=X,
        table "PO Specifications"=X,
        table QuoteSpecifications=X,
        report "Ammendement Cum Regularization"=X,
        report "Ammendement Order"=X,
        report "Assets Register"=X,
        report "Bank Payment voucher New"=X,
        report "CAPITAL ASSET MOVEMENT"=X,
        report "Category Wise Stock Summary"=X,
        report ComparitiveStatement=X,
        report "Enquiry Report"=X,
        report "ETPL Indent Report"=X,
        report "Fixed Asset Register New"=X,
        report "Indent Req Detailed Report"=X,
        report "Indent Requisition Report"=X,
        report "Issue Return Report Details"=X,
        report NonInventoryItemIssue=X,
        report "Pending PO Details"=X,
        report "PO Amendment Report"=X,
        report "PO Cancellation Report"=X,
        report "PO Ratification"=X,
        report "Product & Supplier Wise Report"=X,
        report "Purchase Enquiry EmailBody"=X,
        report "Purchase Order Report"=X,
        report PurchEnquiryReport=X,
        report "Quot Comparision Statement"=X,
        report "Rate Comparative Statement"=X,
        report "Regularization Order New"=X,
        report "RFQ Response Report"=X,
        report "Self Invoice"=X,
        report "Single Quotation Report"=X,
        codeunit "Check Codeunit"=X,
        codeunit CWIP=X,
        page "Closed Indent List"=X,
        page "Complete CentralIndentReq List"=X,
        page "Completed Purchase Order lists"=X,
        page CompleteLocalIndentReqList=X,
        page CWIP=X,
        page "CWIP Details"=X,
        page "CWIP Ledger Entries"=X,
        page "CWIP List"=X,
        page "CWIP Subform"=X,
        page "PO Terms and Specifications"=X,
        page "Posted CWIP"=X,
        page "Posted CWIP List"=X,
        page "Posted CWIP Subform"=X,
        page "Posted Transfer Indent Header"=X,
        page "Posted Transfer Indent List"=X,
        page "Purchase Line Item Picture"=X,
        page "Quot Comparision Line Picture"=X,
        page QuoteSpecifications=X,
        page "Vendor List_B2B"=X;
}