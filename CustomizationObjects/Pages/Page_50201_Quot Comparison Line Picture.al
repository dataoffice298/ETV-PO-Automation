page 50201 "Quot Comparision Line Picture"
{
    Caption = 'Quot Comp Line Picture';
    DeleteAllowed = false;
    InsertAllowed = false;
    LinksAllowed = false;
    PageType = CardPart;
        ...
        area(processing)
        {
            ...
            action(ExportFile)
            {
                ...
                begin
                    ...
                    ConvertedCodeType := Format("Item No.");
    ...
    local procedure OnAfterDeleteItemPicture(var QuotCompTest: Record "Quotation Comparison Test")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterTakeNewPicture(var QuotCompTest: Record "Quotation Comparison Test"; IsPictureAdded: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnImportFromDeviceOnAfterModify(var QuotCompTest: Record "Quotation Comparison Test")
    begin
    end;
}