                ...
                begin
                    ...
                    if PostedPurchRcptGRec.FindSet() then begin
                        repeat
                            ...
                            TotalAmount := TotalGSTAmount + (("Purch. Rcpt. Line".Quantity * "Purch. Rcpt. Line"."Direct Unit Cost" * "Purch. Rcpt. Line"."Line Discount %") / 100) + ("Purch. Rcpt. Line".Quantity * "Purch. Rcpt. Line"."Direct Unit Cost");//B2BAJ12012024
