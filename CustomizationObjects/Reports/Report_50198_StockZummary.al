/*report 50198 "Current Stock Report Bew"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    ProcessingOnly = true;
    Caption = 'Category Wise Stock Summary_50198';
            ...
            begin
                ...
                if ItemVariant.FindFirst() then begin
                    repeat
                        ...
                        TempExcelBuffer.AddColumn(Item."Base Unit of Measure", FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Numb
                 ...
                 TempExcelBuffer.AddColumn(Openingstock, FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);
                        ...
                        TempExcelBuffer.AddColumn(Round(Openingstock * Unitrate, 0.01), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Ty
                 TempExcelBuffer.AddColumn(InwardStock, FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);
                        TempExcelBuffer.AddColumn(Unitrate, FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);//B2BSSD15MAY2023
                        TempExcelBuffer.AddColumn(Round(InwardStock * Unitrate, 0.01), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Typ
                 TempExcelBuffer.AddColumn(OutwardStock, FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);
                        TempExcelBuffer.AddColumn(Unitrate, FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);//B2BSSD15MAY2023
                        TempExcelBuffer.AddColumn(Round(OutwardStock * Unitrate, 0.01), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Ty
                 TempExcelBuffer.AddColumn(ClosingStock, FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);
                        TempExcelBuffer.AddColumn(Unitrate, FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);//B2BSSD15MAY2023
                        TempExcelBuffer.AddColumn(Round(ClosingStock * Unitrate, 0.01), FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Ty
                 TempExcelBuffer.AddColumn(LocationGvar, FALSE, '', FALSE, FALSE, FALSE, '', TempExcelBuffer."Cell Type"::Text);//B2BSSD16MAY
